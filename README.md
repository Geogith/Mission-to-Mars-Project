...
The following steps were taken for web scraping using the above sites:
...
After completing all steps, screenshots of featured images were uploaded to show that the code ran successfully.
